// For additional info see https://adventofcode.com/2024/day/5
package main
...
func main() {
	...
	for {
		...
		if !already_present {
			...
			// Otherwise merge it with the already
	...
	fmt.Println("The correctly ordered updates sum is", middle_page_sum)
}
