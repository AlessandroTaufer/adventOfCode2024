// Additional info at https://adventofcode.com/2024/day/7
package main
...
func validateEquation(result int, operands []int) bool {
	fmt.Println("Validating: ", result, ":", operands)
	...
	return validateEquation(result, add_subset) || validateEquation(result, multiply_subset)
}
